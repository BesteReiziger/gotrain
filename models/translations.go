...
var causeTranslations = map[string]string{
	...
	"door een persoon op het spoor":                                      "due to a person on the track",
	"door een persoon langs het spoor":                                   "due to a people along the track",
	...
	"door een versperring":                                               "due to an obstruction",
	...
	"door inzet van hulpdiensten":                                        "due to a deployment of emergency services",
	...
	"door een bedevaart":                                                 "due to a pilgrimage",
	...
	"door blikseminslag":                                                 "due to a lightning strike",
	"door wateroverlast":                                                 "due to flooding",
	"door problemen op het spoor in het buitenland":                      "due to problems on the track abroad abroad",
	...
	"door het onverwacht ontbreken van personeel":                        "due to unexpectedly missing crew",
	...
	"door een staking bij Arriva":                                        "due to a strike at Arriva",
	"door een staking bij NS":                                            "due to a strike at NS",
